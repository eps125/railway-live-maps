...
import { sClassStatesForBundle, type LiveState } from "./liveState.js";
...
export async function reconstructStateAt(
  ...
  const [{ sourceSequence, berths }, sClass, { gaps, coversAt }] = await Promise.all([
    ...
    sClassStatesForBundle(pool, bundle, at, false),
